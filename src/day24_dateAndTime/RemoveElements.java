...
public class RemoveElements {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i) < 4){
                list.remove(i); // do not use "Remove" method inside the loop
            }
        }
        System.out.println(list);

        System.out.println("_______removeIf method________________________________________________________");
        ...
        System.out.println("_______________removeIf method in_String___________________________________________________________");
